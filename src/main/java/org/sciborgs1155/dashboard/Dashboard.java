...
public class Dashboard {
  ...
  public Dashboard() {
    ...
    redButton.addActionListener(
        e -> {
          changeBackground("images/redbg.png", redButton);
        });
    ...
    blueButton.addActionListener(
        e -> {
          changeBackground("images/bluebg.png", blueButton);
        });
  ...
  private void changeBackground(String imgPath, JButton button) {
    try {
      ...
      if (imgPath.contains("bluebg")) {
        ...
        levelsButtons
            .get(0)
            .setIcon(new ImageIcon(ImageIO.read(getClass().getResource("images/l1.png"))));
        levelsButtons
            .get(1)
            .setIcon(new ImageIcon(ImageIO.read(getClass().getResource("images/L2.png"))));
        levelsButtons
            .get(2)
            .setIcon(new ImageIcon(ImageIO.read(getClass().getResource("images/L3.png"))));
        levelsButtons
            .get(3)
            .setIcon(new ImageIcon(ImageIO.read(getClass().getResource("images/L4.png"))));
        ...
        levelsButtons
            .get(0)
            .setIcon(new ImageIcon(ImageIO.read(getClass().getResource("images/rL1.png"))));
        levelsButtons
            .get(1)
            .setIcon(new ImageIcon(ImageIO.read(getClass().getResource("images/rL2.png"))));
        levelsButtons
            .get(2)
            .setIcon(new ImageIcon(ImageIO.read(getClass().getResource("images/rL3.png"))));
        levelsButtons
            .get(3)
            .setIcon(new ImageIcon(ImageIO.read(getClass().getResource("images/rL4.png"))));
        ...
        ((JButton) panel.getComponent(panel.getComponentCount() - 4))
            .setIcon(
                new ImageIcon(
                    ImageIO.read(getClass().getResource("images/rrst.png")))); // Reset button
      }
      panel.setBackground(bgColor);
    } catch (Exception e) {
      e.printStackTrace();
